...
keymap.set("n", "<leader>l", "<cmd>exec 'se rnu!'<cr>", { desc = "toggle relative line numbers on and off" })
...
vim.keymap.set("v", "<leader>s", [[:s///g<Left><Left><Left>]], { desc = "replace within selection" })
